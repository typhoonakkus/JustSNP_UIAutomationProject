...
public class Assertion extends DriverManager {
    ...
    public static void TextIncludes(WebElement element , String expectedText) {
        ...
        Assert.assertTrue(element.getText().contains(expectedText),
                "Assert error !!!!! Text of the element does not include expected value: " + expectedText);
        Allure.addAttachment("TextIncludesAssertScreen", new ByteArrayInputStream(Util.takeScreenShot()));
    }
    ...
    public static void assertTrue(boolean condition, String message) {
        try {
            ...
            Allure.addAttachment("AssertTrueScreenshot", new ByteArrayInputStream(Util.takeScreenShot()));
            Reporter.log("True Assertion passed **********");
        } catch (AssertionError e) {
            System.out.println("Assertion failed (true expected): " + e.getMessage());
            Reporter.log("True Assertion failed **********");
            throw e;
        }
    }
    ...
    public static void assertFalse(boolean condition, String message) {
        try {
            ...
            Allure.addAttachment("AssertFalseScreenshot", new ByteArrayInputStream(Util.takeScreenShot()));
            Reporter.log("False Assertion passed **********");
        } catch (AssertionError e) {
            System.out.println("Assertion failed (false expected): " + e.getMessage());
            Reporter.log("False Assertion failed **********");
            throw e;
        }
    }
