	...
	public enum TimeOut {
	  ...
	  public int getValue() {
	   ...
	   public static void clickFunction(WebElement clickElement ,TimeOut timeOut){
		...
		public static boolean checkImagesLoaded() {
		...
		public static boolean checkPageLoaded() {
			JavascriptExecutor js = (JavascriptExecutor) DriverManager.getDriver();
			return js.executeScript("return document.readyState").toString().equals("complete");
		}

		public static void verifyPageAndImages() {
			Assertion.assertTrue(checkPageLoaded(), "Page load error!");
			Assertion.assertTrue(checkImagesLoaded(), "Image load error!");
		}
